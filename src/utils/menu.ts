export const commands = [
  ...
  },
  {
    ...
    example: 'Utiliza el comando /euro y el bot te responderá con un mensaje que contendrá los valores de cada entidad monitora del euro, su última fecha de actualización y un promedio entre todas las entidades monitoras.'
  },
  {
    title: 'fuente',
  ...
  },
  {
    ...
    example: 'Utiliza el comando /fuente <nombre> y el bot te responderá con un mensaje que contendrá los valores de cada entidad monitora del euro que haya coincidido con el nombre que suministraste. Por ejemplo, "/fuente Monitor".'
  },
  {
    title: 'calcular',
  ...
  },
  {
    ...
    example: 'Utiliza el comando /calcular <moneda> <monto> <fuente> y el bot te responderá con el cálculo correspondiente. El bot realizará el cálculo en la moneda opuesta a la indicada. Por ejemplo, si escribes "/calcular EUR 50", el bot te dará el valor en bolívares de €50. Si proporcionas una fuente específica, solo se mostrarán los cálculos basados en esas fuentes. Siguiendo el ejemplo anterior, "/calcular € 50 Paralelo" filtrará los resultados a la fuente "Paralelo" para calcular el valor en bolívares de €50.'
  },
  {
    title: 'avisos',
    command: '/avisos',
