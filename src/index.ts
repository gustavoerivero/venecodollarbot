...
init().catch((err) => console.log(`Init database error:`, err));
...
const calculator = async (
  ...
  if (command.startsWith('/calcular') && (param1 === '$' || param1.toLowerCase() === 'bs') && param2) {
    try {
    ...
    command.startsWith('/euroCalcular') &&
